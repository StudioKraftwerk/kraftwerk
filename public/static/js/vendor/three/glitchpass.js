...
THREE.GlitchPass.prototype = {
    ...
    render: function ( renderer, writeBuffer, readBuffer, delta )
    {
        ...
        if(this.curF % this.randX == 0 || this.goWild==true)
        {
            ...
            this.uniforms[ 'angle' ].value=THREE.Math.randFloat(-Math.PI/10,Math.PI/10);
            ...
            this.uniforms[ 'seed_y' ].value=THREE.Math.randFloat(-0.2,0.2);
            this.curF=0;
    ...
    {
        this.randX=THREE.Math.randInt(120,840);
    },
